...
#else
#define LINUX_ID "230410"  // replace with game path number
#define DEFAULT_PATH "/home/$USER/.local/share/Steam/steamapps/compatdata/" LINUX_ID "/pfx/drive_c/users/steamuser/AppData/Local/Warframe/EE.log"
#endif
...
static gboolean refresh_count(gpointer user_data) {
    ...
    char expanded_path[MAXLEN];
    snprintf(expanded_path, MAXLEN, file_path, getenv("USER"));
    file_path = expanded_path;
#endif
